...
class _EditarExercicioScreenState extends State<EditarExercicioScreen> {
  ...
  void _atualizarExercicio() async {
    if (_formKey.currentState!.validate()) {
      final exercicioAtualizado = Exercicio(
        ...
        observacoes: _observacoesController.text.isEmpty ? '' : _observacoesController.text,
  ...
  Widget _buildInput(String label, TextEditingController controller,
      {TextInputType tipo = TextInputType.text, bool obrigatorio = true}) {
    return Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildInput('Duração (minutos)', _duracaoController,
              ...
              Align(
                alignment: Alignment.centerLeft,
                child: const Text('Dias da semana:'),
              ),
